export const MAP = {
    ...
    areas: [
      { name: "Panhandle", shape: "circle", coords: [124,48,20], preFillColor: "clear" },
      { name: "Sandhills", shape: "circle", coords: [254, 62, 20], preFillColor: "clear" },
      ...
      { name: "Metro", shape: "circle", coords: [610, 175, 20], preFillColor: "clear" }
    ]
}